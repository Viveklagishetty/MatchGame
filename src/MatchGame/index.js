...
class MatchGame extends Component {
  ...
  render() {
    const {timer, score, isGameOver, category, imgUrl} = this.state
    ...
    return (
      <div className="main-div">
        <nav className="top-bar">
          ...
          />
          <ul className="top-right-div">
            <li className="scoreP">
              <p>
                Score:<span className="timer">{score}</span>
              </p>
            </li>
            <li className="top-right-div">
              <img
                className="timer-img"
                alt="timer"
        ...
        {!isGameOver && (
          <div className="gameDiv">
            <img src={imgUrl} className="main-img" alt="match" />
            <ul className="tab-ul">
